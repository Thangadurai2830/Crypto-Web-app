...
# CORS: handle OPTIONS preflight first for any localhost origin (outermost)
...
class LocalhostCORSMiddleware(BaseHTTPMiddleware):
    """Return 200 + CORS headers for OPTIONS from any localhost port so preflight never hits router (400)."""
